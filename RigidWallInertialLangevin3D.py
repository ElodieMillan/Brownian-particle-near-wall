...
class RigidWallInertialLangevin3D(InertialLangevin3D):  # hérite de Inertial
    ...
    def _PositionXi(self, xi_1, xi_2, zi_1, rng, axis=None):
        ...
        #### Cas dérivée centrée xi+1 - xi-1 /2dt
...
if __name__ == "__main__":
    langevin3D = RigidWallInertialLangevin3D(
        dt=1e-7, Nt=1000000, R=1e-6, rho=2000, x0=(0.0, 0.0, 1e-6)
    )
